var hot,hotter,hottest,tooHot,hooks;var currentInterval=[];var user;var columnHeaders;function checkPrivilege(){user=sessionStorage.getItem("currentUser");if(user==undefined){alert("Please log into your account.");window.open("Login.html","_self",!1)}
...
function forceRefresh(subaction){var tempUserName;var elements=document.getElementsByClassName("activeUser");if(elements.length!=1){alert("No user has been selected.");return}else{tempUserName=elements[0].innerHTML}
var temp=confirm("This will force a refresh of the user's screen");if(temp==!1){return}
var requestURL="http://localhost:8888/PsychPHP/Tester.php";httpRequest=new XMLHttpRequest()
httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent("admin")+"&endUser="+encodeURIComponent(tempUserName)+"&action="+encodeURIComponent("forceRefresh")+"&subaction="+encodeURIComponent(subaction));alert("Refresh command sent.")}
function cancelRefresh(){var tempUserName;var elements=document.getElementsByClassName("activeUser");if(elements.length!=1){alert("No user has been selected.");return}else{tempUserName=elements[0].innerHTML}
var temp=confirm("This will cancel the refresh request of the user's screen. WARNING! The refresh may have already been completed");if(temp==!1){return}
var requestURL="http://localhost:8888/PsychPHP/Tester.php";httpRequest=new XMLHttpRequest()
httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent("admin")+"&endUser="+encodeURIComponent(tempUserName)+"&action="+encodeURIComponent("forceRefresh"));alert("Refresh command sent.")}
function insertParticipant(username,tasknum){unorderedlist=document.getElementById("participantsList");listItem="<li><button class='btn' onclick=\"getTaskNum('"+username+"',"+tasknum+")\">"+username+"</button></li>";temp=unorderedlist.innerHTML;unorderedlist.innerHTML=temp+listItem}
function getTaskNum(username,tasknum){for(let i=0;i<currentInterval.length;i++){clearInterval(currentInterval[i])}
user=username;var temp=document.getElementsByClassName("activeUser");for(let i=0;i<temp.length;i++){temp[i].classList.remove("activeUser")}
event.srcElement.classList.add("activeUser");requestTask(username);if(document.getElementById("autoRefreshCheckBox").checked==!0){autoRefresh();for(let i=0;i<currentInterval.length;i++){clearInterval(currentInterval[i])}
var temp=setInterval(requestTask,3000,username);currentInterval.push(temp)}}
function requestGoals(user){var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";xhttpRequest=new XMLHttpRequest()
xhttpRequest.onreadystatechange=loadGoals;xhttpRequest.open('POST',requestURL);xhttpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');xhttpRequest.send('userName='+encodeURIComponent("admin")+'&user='+encodeURIComponent(user)+"&action="+encodeURIComponent("requestGoals"))}
function loadGoals(){try{if(xhttpRequest.readyState===XMLHttpRequest.DONE){if(xhttpRequest.status===200){var response=xhttpRequest.responseText;response=JSON.parse(response);document.getElementById("gridContainer4").innerHTML="";loadGoalsTable(response)}else{alert('There was a problem with the request.')}}
return 1}catch(e){alert('Caught Exception: loadGoals'+e.description)}}
...
httpRequest.onreadystatechange=loadCurrentTask;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+"&action="+encodeURIComponent("requestTask"));requestGoals(username)}
...
return 1}catch(e){alert('Caught Exception: loadCurrentTask'+e.description)}}
...
if(tasknum==2){document.getElementById("mainContainer").innerHTML="<div id='gridContainer' ></div>";loadMemo(username)}
...
function loadFinancialInfoTable(username){document.getElementById("mainContainer").innerHTML="<div id='gridContainer' ></div>";columnHeaders=['Date','Check Number','Amount','Timestamp'];var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";httpRequest=new XMLHttpRequest();httpRequest.onreadystatechange=loadTable;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+'&action='+encodeURIComponent('financial'))}
function loadSortedFiles(username){document.getElementById("mainContainer").innerHTML="<div id='gridContainer'></div>";columnHeaders=['File Name','Folder Selected','Timestamp'];var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";httpRequest=new XMLHttpRequest();httpRequest.onreadystatechange=loadTable;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+'&action='+encodeURIComponent('files'))}
function loadMemo(username){document.getElementById("mainContainer").innerHTML="<div id='gridContainer'></div>";columnHeaders=['Memo Text','Timestamp'];var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";httpRequest=new XMLHttpRequest();httpRequest.onreadystatechange=loadTable;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+'&action='+encodeURIComponent('memo'))}
function loadLabelingApointments(username){document.getElementById("mainContainer").innerHTML="<div id='gridContainer' ></div>";columnHeaders=['First Name','Last Name','Appointmnet Number','Selected Option','Timestamp'];var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";httpRequest=new XMLHttpRequest();httpRequest.onreadystatechange=loadTable;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+'&action='+encodeURIComponent('labelAppointment'))}
function loadCrossCheckInfoTable(username){document.getElementById("mainContainer").innerHTML="<div id='gridContainer' ></div>";columnHeaders=['Date','Patient Name','Patient Age','Patient Height','Patient Weight','Timestamp'];var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";httpRequest=new XMLHttpRequest();httpRequest.onreadystatechange=loadTable;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+'&action='+encodeURIComponent('crossCheck'))}
function loadPercentages(username){document.getElementById("mainContainer").innerHTML="<div id='gridContainer' ></div>";columnHeaders=['Appts Attended','Appts Late','Appts Missed','% Attended','% Late','Timestamp'];var requestURL="http://localhost:8888/PsychPHP/AdminDetails.php";httpRequest=new XMLHttpRequest();httpRequest.onreadystatechange=loadTable;httpRequest.open('POST',requestURL);httpRequest.setRequestHeader('Content-Type','application/x-www-form-urlencoded');httpRequest.send('userName='+encodeURIComponent(username)+'&action='+encodeURIComponent('percentage'))}
function pes(){}
...
return 1}catch(e){alert('Caught Exception: loadTable -'+e.description)}}
function loadGrid(response){var data=response;var container=document.getElementById('gridContainer');hot=new Handsontable(container,{data:data,rowHeaders:!0,minCols:0,minRows:0,minSpareRows:2,columnSorting:!0,readOnly:!0,colHeaders:columnHeaders,contextMenu:!0,fillHandle:{autoInsertRow:!1,}})}
...
function loadGoalsTable(response){var data=response;var container=document.getElementById('gridContainer4');tooHot=new Handsontable(container,{data:data,rowHeaders:!0,minCols:0,minRows:0,startCols:3,minSpareRows:1,columnSorting:!1,colHeaders:['Goal Type','Goal Amount','Time taken to hit goal (in seconds)'],contextMenu:!0,readOnly:!0,fillHandle:{autoInsertRow:!1,},})}
function registerHooks(){Handsontable.hooks.add('afterChange',function(change,source){saveChanges()},hotter);Handsontable.hooks.add('afterRemoveRow',function(change,source){saveChanges()},hotter)}
...
return 1}catch(e){alert('Caught Exception: testFunc -'+e.description)}}
function autoRefresh(){var y=document.getElementById("autoRefreshCheckBox");var icon=document.getElementById("refreshing");if(y.checked==!1){icon.classList.remove("shown");icon.classList.add("hidden");for(let i=0;i<currentInterval.length;i++){clearInterval(currentInterval[i])}}else{icon.classList.add("shown");icon.classList.remove("hidden");requestTask(user);for(let i=0;i<currentInterval.length;i++){clearInterval(currentInterval[i])}
var temp=setInterval(requestTask,3000,user);currentInterval.push(temp)}}
function showPane(activePane){document.getElementById("goals").style.display="none";document.getElementById("loginInfo").style.display="none";document.getElementById("liveFeed").style.display="none";document.getElementById("refreshPage").style.display="none";document.getElementById(activePane).style.display="block"}
